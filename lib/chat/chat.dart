...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final SendBirdRepos _sendbird = SendBirdRepos();
  var uuid;
  @override
  void initState() { 
    super.initState();
 ...
 Widget build(BuildContext context) {
  ...
  // _connectToSendbirdServer() {
  //   var resp = FutureBuilder<dynamic>(
  //       future: _sendbird.connectToSendbirdServer(uuid),
  //       initialData: false,
  //       builder: (context, AsyncSnapshot<dynamic> snapshot) {
  //         if (snapshot.hasData) {
  //           print('chekcin SnapShot $snapshot');
  //             // return ChatScreen();
  //           }else{
  //             print('chekcin Else $snapshot');
